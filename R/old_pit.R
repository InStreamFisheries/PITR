...
#' @return List of data frames consisting of detection records, event records, non-detection and non-event records, duplicated detections, error records, and a character vector of unique readers.
